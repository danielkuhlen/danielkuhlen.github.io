...
My research focuses on non-democratic politics, with particular attention to public support for repression and political violence. In my dissertation project, which is supervised by [Felix Haass](https://felixhaass.de), I examine why and when citizens support authoritarian rule. Methodologically, I rely on (quasi-)experimental methods, geospatial analysis, and remote sensing.
